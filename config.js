const nameGirl = 'Htr Cuti';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 14-2';
const titleCard = 'Give for lover';
const contentCard = 'Chúc my love 14/2 tràn ngập niềm vui và hạnh phúc. Tối nay 7h trốn c Sen đi chơi với anh nhé:))!';
